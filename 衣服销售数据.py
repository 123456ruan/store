...
print("-----------------------------------------------------------------")
sum=253.6 * 10 + 86.3 * 60 + 96.8 * 43 + 135.9 * 63+ 65.8 * 63+ 49.3 * 120+ 86.3 * 72+ 253.6 * 69+ 86.3 * 35 + 253.6  * 140 \
    + 86.3 * 90+ 135.9 * 24+ 65.8 * 45+ 96.8 * 25+ 86.3 * 60 + 65.8 * 129+ 253.6 * 	10+ 96.8 * 43+ 65.8 * 63 + 86.3 * 60 \
    + 135.9 * 63+ 96.8 * 60+ 65.8 * 58+ 86.3 * 140+ 65.8 * 48 + 96.8 * 43+ 135.9 * 57+ 253.6 * 10+ 65.8 * 63 + 96.8 * 78
print("12月份销售总金额:",sum)
print("羽绒服销售占比:",(10+69+140+10+10)/500)
print("皮草销售占比:",(63+24+63+57)/855)
print("牛仔裤销售占比:",(60+72+35+90+60+60+140)/600)
print("风衣销售占比:",(43+25+43+60+43+78)/335)
print("衬衫销售占比:",120/562)
print("T血销售占比:",(63+45+129+63+58+48+63)/632)
print("羽绒服销售额的占比：",(10+69+140+10+10)*253.6/sum)
print("皮草销售额的占比:",(63+24+63+57)*135.9/sum)
print("牛仔裤销额的售占比:",(60+72+35+90+60+60+140)*86.3/sum)
print("风衣销售额的占比:",(43+25+43+60+43+78)*96.8/sum)
print("衬衫销售额的占比:",120*49.3/sum)
print("T血销售额的占比:",(63+45+129+63+58+48+63)*65.8/sum)
